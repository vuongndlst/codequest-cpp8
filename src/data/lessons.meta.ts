...
export const LESSONS_META: LessonMeta[] = [
  {
    ...
    title: 'Kiến thức nền và cú pháp cơ bản',
    subtitle: 'Những viên gạch đầu tiên của một chương trình C++',
    intro:
      'Cổng làng Khởi Động đã tắt điện từ nhiều ngày nay. Các Bug đã xoá mất những dòng lệnh cơ bản giữ cho ngôi làng sáng đèn. Em là Code Guardian được cử tới để viết lại chúng.',
    objectives: [
      'Nhận biết cấu trúc cơ bản của một chương trình C++',
      'Hiểu vai trò của #include <iostream> và using namespace std;',
      'Biết hàm main() là nơi chương trình bắt đầu chạy',
      'Dùng cout để hiển thị thông tin ra màn hình',
      'Khai báo và sử dụng biến đơn giản',
      'Nhớ dấu ; ở cuối câu lệnh và cặp ngoặc nhọn { }',
      'Viết code có thụt lề hợp lý',
    ],
